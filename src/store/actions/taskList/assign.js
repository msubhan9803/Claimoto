...
// Root Getters
export const getAssignProvider = ({ records_per_page, page_index, search_text, search_option, sort_name, sort_type }) => async dispatch => {
    try {
        ...
        dispatch({ type: GET_ASSIGN_PROVIDER_REQUEST, payload: { modeule: "garages", bool: false, list: [] } });
        console.log(error);
    }
}
