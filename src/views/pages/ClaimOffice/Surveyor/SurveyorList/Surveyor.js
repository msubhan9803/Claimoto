...
import SurveyorList from "components/ClaimOffice/Surveyor/SurveyorList";

function Surveyor() {
  let providerTypeId = 4; // Agencies Provider primary key
  const dispatch = useDispatch();
  const providers = useSelector((state) => state.claimSurveyorsReducer.allProviders);
  const {
    isSuccess,
    isLoading,
    allProviders,
    ...
    search_options
  } = useSelector((state) => state.claimSurveyorsReducer);
  const {
    search_text,
    search_option,
    sort_name,
              ...
              <div className="row">
                <div className="col-lg-9">
                  <div className="ltnd__page-title-area">
                    <h2>Surveyor list ({providers.length})</h2>
                  </div>
                </div>
            ...
            <div className="select-availability-area pb-4">
              <div className="row">
                <div className="col-lg-12">
                  <SurveyorList loading={isLoading} allProviders={allProviders} />
