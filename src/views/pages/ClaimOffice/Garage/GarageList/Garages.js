...
import GaragesList from "components/ClaimOffice/Garage/GarageList";

function Garages() {
  let providerTypeId = 1; // Agencies Provider primary key
  const dispatch = useDispatch();
  const providers = useSelector((state) => state.claimGaragesReducer.allProviders);
  const {
    isSuccess,
    isLoading,
    allProviders,
    ...
    search_options
  } = useSelector((state) => state.claimGaragesReducer);
  const {
    search_text,
    search_option,
    sort_name,
            ...
            <div className="select-availability-area pb-4">
              <div className="row">
                <div className="col-lg-12">
                  <GaragesList loading={isLoading} allProviders={allProviders} />
