    ...
    return (
        <React.Fragment>
            <div className="body-wrapper">
                <header className="ltnd__header-3 bg-white">
                ...
                <div className="body-content-area ltnd__no-sidebar-menu body-100vh body-bg-1--- pb-80---">
                                ...
                                <div className="col-lg-6 col-md-8 offset-lg-3 offset-md-2">
                                    <div className="terms-conditions-info">
                                        ...
                                        <p>
                                            ...
                                            the release of Letraset sheets containing Lorem Ipsum
                                            passages, and more recently with desktop publishing software
                                            like Aldus PageMaker including versions of Lorem Ipsum.orem
                                            ...
                                            versions of Lorem Ipsum.orem Ipsum is simply dummy text of the
